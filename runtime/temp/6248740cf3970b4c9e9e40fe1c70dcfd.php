<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"/www/wwwroot/xiaoyun.wutao7.top/public/../application/service/view/setting/index.html";i:1640153840;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<form class="layui-row layui-col-space10 layui-form">
    <div class="layui-col-md12">
        <div class="layui-card" style="margin-left: 20px;margin-top: 20px;">
            ...
            <div class="layui-form-item" style="margin-top: 20px">
                ...
                <div class="layui-input-inline">
                    <select name="lang" lay-verify="required">
                        ...
                        <?php $_6386e0d17b23f=config('lang'); if(is_array($_6386e0d17b23f) || $_6386e0d17b23f instanceof \think\Collection || $_6386e0d17b23f instanceof \think\Paginator): if( count($_6386e0d17b23f)==0 ) : echo "" ;else: foreach($_6386e0d17b23f as $key=>$vo): ?>
            ...
            <div class="layui-form-item">
                <label class="layui-form-label" style="width: 120px">消息对话实时翻译</label>
                <div class="layui-input-inline">
            ...
            <div class="layui-form-item" style="margin-top: 20px">
                <label class="layui-form-label" style="width: 100px">百度地图AK</label>
                <div class="layui-input-block">
                    <input name="bd_location_ak" value="<?php echo $business['bd_location_ak']; ?>" class="layui-input" style="width: 250px;display: inline-block;margin-right: 10px"/>
                    <span>百度地图开放平台【<a href="https://lbsyun.baidu.com/apiconsole/key/create#/home" target="_blank">点击申请</a>】</span>
                </div>
            </div>
            <div class="layui-form-item">
